...
contextBridge.exposeInMainWorld('harness', {
  ...
  favsGet: () => ipcRenderer.invoke('favs-get'),
  favsSet: (list) => ipcRenderer.invoke('favs-set', list),
  onFavsUpdated: (cb) => ipcRenderer.on('favs-updated', (_e, d) => cb(d.favs)),
  ...
  ptyOpen: (id) => ipcRenderer.invoke('pty-open', id),
  ...
  mcpOauth: (name) => ipcRenderer.invoke('mcp-oauth', name),
  mcpSetToken: (name, token) => ipcRenderer.invoke('mcp-set-token', { name, token }),
  mcpPrompts: () => ipcRenderer.invoke('mcp-prompts'),
  mcpPromptGet: (server, name, args) => ipcRenderer.invoke('mcp-prompt-get', { server, name, args }),
